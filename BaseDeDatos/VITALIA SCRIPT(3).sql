...
INSERT INTO Vitalia.Productos (descripcion, precio, imagen, nombre, Categoria_id) VALUES ('Esencia natural extraída de flores silvestres, una alternativa natural para mejorar la calidad de vida. La planta se ha utilizado para curar heridas, abscesos, quemaduras, eczema y úlceras, para tratar el resfriado común y como carminativo, antiinflamatorio, antibacteriano, antifúngico, antiviral e inmunoestimulante.', 80.00, '/public/img/image011.webp', 'Esencia Floral Echinacea (25 ml)', 4);
INSERT INTO Vitalia.Productos (descripcion, precio, imagen, nombre, Categoria_id) VALUES ('Auxiliar en problemas de varices, ulceras varicosas, trombosis y hemorroides.', 198.00, '/public/img/indias.webp', 'Castaño De Indias (60 Cap.)', 3);
INSERT INTO Vitalia.Productos (descripcion, precio, imagen, nombre, Categoria_id) VALUES ('Para el alivio de los sintomas del resfriado comun y tos.', 214.00, '/public/img/jarabe azul.webp', 'Jarabe Broncolin Etiqueta Azul Mezcla de Plantas (250 ml)', 3);
INSERT INTO Vitalia.Productos (descripcion, precio, imagen, nombre, Categoria_id) VALUES ('Eucaliptine funciona como un auxiliar en el tratamiento de la tos seca y tos con flemas, así como en el alivio de la garganta irritada.', 410.00, '/public/img/Eucalipto.jpg', 'Eucalipto jarabe (140 ml)', 3);
INSERT INTO Vitalia.Productos (descripcion, precio, imagen, nombre, Categoria_id) VALUES ('Proteína vegetal en polvo sabor chocolate a base de chícharo y arroz, adicionado con enzimas y probióticos que ayudan a una buena salud digestiva.', 300.00, '/public/img/Fibravegetal.jpeg', 'Proteina vegetal (450 gr)', 2);
INSERT INTO Vitalia.Productos (descripcion, precio, imagen, nombre, Categoria_id) VALUES ('Un té real para amantes de lo natural. Infusionado con hojas de té real, sin azúcares añadidos ni saborizantes y 100% natural.', 80.00, '/public/img/Chiatenegro.png', 'Chia mia té negro (350 ml)', 1);
INSERT INTO Vitalia.Productos (descripcion, precio, imagen, nombre, Categoria_id) VALUES ('El té verde es una variedad de té verde japonés que aportan interesantes beneficios y propiedades medicinales, es un antioxidante, mejora la digestión, es antidepresivo y energizante.', 220.00, '/public/img/te-verde.jpg', 'Té Verde en polvo (300 gr)', 1);
INSERT INTO Vitalia.Productos (descripcion, precio, imagen, nombre, Categoria_id) VALUES ('Auxiliar en el tratamiento de Tos y Flemas.', 80.00, '/public/img/jarabeniño.webp', 'Jarabe Eucalín Infantil Mezla de plantas y propóleo (240 ml)', 3);
