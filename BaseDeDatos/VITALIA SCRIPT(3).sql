...
INSERT INTO vitalia.productos (descripcion, precio, imagen, nombre, Categoria_id) VALUES ('Dentro de los beneficios del colágeno hidrolizado se encuentra la función como agente reparador del tejido colectivo del cuerpo', 360.00, '/public/img/colageno.webp', 'Colágeno Hidrolizado (120 Tab.)', 3);
